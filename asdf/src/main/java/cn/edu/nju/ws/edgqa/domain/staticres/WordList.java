...
public class WordList {
    ...
    //0802 update
    public static LinkedHashSet<String> isWordSet = new LinkedHashSet<>(
            Arrays.asList("is", "were", "was","does")
    );
    //0802
    ...
    public static QueryType getCoarseQuestionType(String question) {
        System.out.println("進入getCoarseQuestionType");
        ...
        //     //return QueryType.COMMON;
        // }
        if (judgeIfIs(question)) {
            System.out.println("太棒了！是judge");
    ...
    public static boolean judgeIfIs(String question) {
        for (String word : isWordSet) {
            if (question.trim().toLowerCase().startsWith(word)) {
                return true;
            }
        }
