...
public class QAArgs {
     ...
     */
    private static boolean globalEntityLinking = false;

    /**
     * whether to use global relation linking
     */
    private static boolean globalRelationLinking = false;
     ...
     */
    private static boolean reRanking = false;
     ...
     */
    private static TextMatching textMatchingModel = TextMatching.LEXICAL;
    /**
     ...
     */
    private static int relationNumUpperB = 50;
